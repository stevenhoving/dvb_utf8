...
static int
big5hkscs1999_mbtowc (ucs4_t *pwc, const unsigned char *s, size_t n)
{
...
static int
big5hkscs1999_wctomb (unsigned char *r, ucs4_t wc, size_t n)
{
  int count = 0;
...
static int
big5hkscs1999_reset (unsigned char *r, size_t n)
{
  unsigned char last = conv->ostate;
