...
static int
big5hkscs2004_mbtowc (ucs4_t *pwc, const unsigned char *s, size_t n)
{
...
static int
big5hkscs2004_wctomb (unsigned char *r, ucs4_t wc, size_t n)
{
  int count = 0;
...
static int
big5hkscs2004_reset (unsigned char *r, size_t n)
{
  unsigned char last = conv->ostate;
